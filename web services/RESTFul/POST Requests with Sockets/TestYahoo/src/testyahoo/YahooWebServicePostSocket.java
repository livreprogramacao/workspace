 ...
 *
 * @author Daniel Jones www.danieljones.org Copyright 2007 Daniel Jones
 *
 * This example illustrates how to perform a web service request via HTTP POST.
 * See the YahooWebServicePost example for a similar request using a
 * URLConnection instead of sockets.
 */
import java.net.*;
import java.io.*;
